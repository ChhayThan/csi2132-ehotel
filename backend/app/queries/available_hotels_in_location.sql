SELECT hid, name, address_city, address_street_address, address_country, image, chain_name, rating, phone_number, min_price, num_available_rooms, capacity as total_capacity FROM hotel 
JOIN (
